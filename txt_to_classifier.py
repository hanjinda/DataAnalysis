...
for num in range (file_start, file_end):
	...
	for num, line in enumerate(f):
		...
		if "Definition: " in line:
			...
			if line[1] != "":
				f_out.write(str(file_line_num) +"\t" + str(file_line_num + 10000) +"\n")
		...
		if "Symptoms and Signs: " in line:
			...
			if line[1] != "":
				f_out.write(str(file_line_num) +"\t" + str(file_line_num + 20000) +"\n")
		...
		if "Treatment: " in line:
			...
			if line[1] != "":
				f_out.write(str(file_line_num) +"\t" + str(file_line_num + 30000) +"\n")
		...
		if "Causes: " in line:
			...
			if line[1] != "":
				f_out.write(str(file_line_num) +"\t" + str(file_line_num + 40000) +"\n")
		...
		if "Diagnosis: " in line:
			...
			if line[1] != "":
				f_out.write(str(file_line_num) +"\t" + str(file_line_num + 50000) +"\n")
